...
- **Machine fingerprint** (CPU + MAC + hostname + machine-id hash) for license binding

## Data handling

What RedWake sends to the license server:
- License key (for verification)
- Machine fingerprint hash (for binding)
...
- Personal information (no telemetry beyond heartbeat)
