"""Pure input builders for RedWake scan runs."""
...
from redwake.config.models import DEFAULT_MODEL_RETRY, model_supports_reasoning


if TYPE_CHECKING:
    from redwake.config.settings import ReasoningEffort
...
def build_scope_context(scan_config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "authorization_source": "redwake_platform_verified_targets",
