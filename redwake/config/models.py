...
if TYPE_CHECKING:
    ...
    from redwake.config.settings import Settings


class RedWakeProvider(MultiProvider):
...
def configure_sdk_model_defaults(settings: Settings) -> None:
    """Apply RedWake config to SDK-native defaults."""
    llm = settings.llm
...
def _configure_litellm_compatibility() -> None:
    ...
    # RedWake uses LiteLLM's success callback to capture provider-reported cost.
