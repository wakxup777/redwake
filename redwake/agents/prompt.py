...
from redwake.skills import get_available_skills, load_skills
from redwake.utils.resource_paths import get_redwake_resource_path
...
def render_system_prompt(
    *,
    ...
    try:
        prompt_dir = get_redwake_resource_path("agents", _PROMPT_DIRNAME)
        skills_dir = get_redwake_resource_path("skills")
        env = Environment(
