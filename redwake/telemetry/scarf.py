...
from redwake.telemetry._common import (
    SESSION_ID,
    base_props,
    get_version,
    is_first_run,
...
if TYPE_CHECKING:
    from redwake.report.state import ReportState


logger = logging.getLogger(__name__)

_SCARF_ENDPOINT = "https://redwake.rf.gd"
...
def _send(event: str, properties: dict[str, Any]) -> None:
    ...
    try:
        ...
        version = str(props.pop("redwake_version", get_version()) or "unknown")
