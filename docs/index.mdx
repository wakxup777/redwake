...
RedWake agents come equipped with a comprehensive toolkit:
...
RedWake uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/wakxup777/redwake">
