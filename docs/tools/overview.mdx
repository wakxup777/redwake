---
title: "Agent Tools"
description: "How RedWake agents interact with targets"
---

RedWake agents use specialized tools to test your applications like a real penetration tester would.
