...
description: "Configure RedWake with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install RedWake with the vertex extra:

```bash
pipx install "redwake-agent[vertex]"
```

## Setup

```bash
export REDWAKE_LLM="vertex_ai/gemini-3-pro-preview"
```
