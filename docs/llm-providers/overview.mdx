---
title: "Overview"
description: "Configure your AI model for RedWake"
---

RedWake uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export REDWAKE_LLM="ollama/llama4"
