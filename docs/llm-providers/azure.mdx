---
title: "Azure OpenAI"
description: "Configure RedWake with OpenAI models via Azure"
---

## Setup

```bash
export REDWAKE_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `REDWAKE_LLM` | `azure/<your-deployment-name>` |
...
```bash
export REDWAKE_LLM="azure/gpt-5.4-deployment"
