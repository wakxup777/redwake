# Contributing to RedWake

Thank you for your interest in contributing to RedWake! This guide will help you get started with development and contributions.
...
4. **Run RedWake in development mode**
   ```bash
...
Skills are specialized knowledge packages that enhance agent capabilities. See [redwake/skills/README.md](redwake/skills/README.md) for detailed guidelines.
...
**Questions?** Reach out on [Discord](https://redwake.rf.gd/contact) or create an issue. We're here to help!
